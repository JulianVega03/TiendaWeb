            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $c->getEstado() ?></td>
                        <td>
                            <a href="<?= URL ?>categorias/editar/<?= $c->getId() ?>"><i class="far fa-edit"></i></a>
                            <a href="<?= URL ?>categorias/eliminar/<?= $c->getId() ?>"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php
                }
