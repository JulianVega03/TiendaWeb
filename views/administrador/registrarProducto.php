...
<body>
    ...
    <article>
        ...
        <form style="text-align: left;" action="<?= URL ?>productos/nuevo" method="post" enctype="multipart/form-data">>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="detalle" cols="30" rows="10"></textarea>
                </div>
            </div>
            <div class="form-group row">
