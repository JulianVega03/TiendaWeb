...
<body>
    ...
    <article>
        ...
        <form style="text-align: left;" action="<?= URL ?>marcas/editarGuardar/<?= $id ?>" method="post">
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Nombre</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="nombre" value="<?= $marca->getNombre() ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Descripción</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="descripcion" value="<?= $marca->getDescripcion() ?>">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
